...
Детальная модель подписок и биллинга описана в `docs/platform/SAAS_BILLING_RU.md`.
...
См. также инфраструктурный документ: `docs/platform/VERCEL_SUPABASE_TEST_PROD.md`.
